...
export function MemberCreateModal({ draft, onDraftChange, onSubmit, onClose, error }: Props) {
        ...
        <div className="p-5 sm:p-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl text-slate-950">Novi član</h2>
            </div>
            <button
              type="button"
          ...
          <form className="mt-6 space-y-5" onSubmit={(e) => void handleSubmit(e)}>
            ...
            <div className="flex flex-col gap-3 pb-2 pt-3 sm:flex-row">
              <button type="submit" className={primaryButtonClasses} disabled={!draft.fullName.trim()}>
                Dodaj člana
              </button>
          ...
          >
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-lg bg-slate-50 p-4">
                ...
                <p className="mt-1 text-sm font-semibold text-slate-900">{draft.fullName || 'Nije navedeno'}</p>
              </div>
            </div>
