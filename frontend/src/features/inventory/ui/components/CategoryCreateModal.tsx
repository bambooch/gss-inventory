...
export function CategoryCreateModal({ draft, onDraftChange, onSubmit, onClose, error }: Props) {
        ...
        <div className="p-5 sm:p-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl text-slate-950">Nova kategorija</h2>
            </div>
            <button
              type="button"
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <input
                  ...
                  value={draft.name}
                  onChange={(e) => onDraftChange({ ...draft, name: e.target.value.toUpperCase() })}
                  required
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => onDraftChange({ ...draft, sortOrder: e.target.value })}
                />
              </div>
            </div>

            <div className="flex flex-col gap-3 pb-2 pt-3 sm:flex-row">
              <button type="submit" className={primaryButtonClasses} disabled={!draft.name || !draft.label}>
                Dodaj kategoriju
              </button>
          ...
          >
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-lg bg-slate-50 p-4">
                ...
                <p className="mt-1 text-sm font-semibold text-slate-900">{draft.label || 'Nije navedeno'}</p>
              </div>
            </div>
